...
export const HeroSection = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      {/* Main Content Container - Adjusted spacing for better balance */}
      <div className={`relative z-10 text-center max-w-6xl mx-auto px-8 flex-1 flex flex-col justify-center items-center pt-8 transition-all duration-1200 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
        {/* Main Title - Optimized positioning */}
        <div className="mb-6">
        ...
        {/* Enhanced Subtitle - Tighter spacing to title */}
        ...
        {/* Enhanced Code Block - Adjusted spacing */}
        <div className={`transition-all duration-1200 delay-600 ease-out mb-24 ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-6 scale-98'}`}>
      ...
      {/* Enhanced Scroll Indicator Section - Positioned significantly lower with more space */}
      <div className={`relative z-10 flex flex-col items-center space-y-10 pb-20 transition-all duration-1200 delay-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        {/* Scroll Text with Enhanced Spacing */}
        <div className="text-base text-slate-600 font-semibold flex items-center justify-center space-x-8 tracking-wide">
          <div className="w-16 h-[2px] bg-gradient-to-r from-transparent via-slate-400 to-transparent"></div>
          <span className="px-4">Scroll to explore</span>
          <div className="w-16 h-[2px] bg-gradient-to-r from-transparent via-slate-400 to-transparent"></div>
        </div>
        
        {/* Enhanced Mouse Icon - Larger and more prominent */}
        <div className="animate-bounce-slow">
          <div className="w-8 h-14 border-[3px] border-slate-500 rounded-full flex justify-center relative group hover:border-slate-600 transition-colors duration-300">
            <div className="w-1.5 h-5 bg-slate-600 rounded-full mt-4 animate-pulse group-hover:bg-slate-700 transition-colors duration-300" />
          </div>
        </div>
      </div>
    </section>
