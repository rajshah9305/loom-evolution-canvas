...
export const HeroSection = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-between items-center relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      {/* Enhanced Scroll Indicator Section - Positioned lower for better visual hierarchy */}
      <div className={`relative z-10 flex flex-col items-center space-y-6 pb-16 mb-8 transition-all duration-1200 delay-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
